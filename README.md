...
> Disclaimer: this is an experimental library performing Taylor based set-propagation and verified reachability analysis similar to COSY/CAPD.  The code is heavily LLM generated based on publications and papers in the field and is subject to major revisions (and bugs).
